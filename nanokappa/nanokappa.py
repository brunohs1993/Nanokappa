...
max_time = timedelta(
    days=max_time[0], hours=max_time[1], minutes=max_time[2], seconds=max_time[3]
)
...
print("---------- o ----------- o ------------- o ------------")
print(
    "Year: {:<4d}, Month: {:>02d}, Day: {:>02d}".format(
        start_time.year, start_time.month, start_time.day
    )
)
print(
    "Start at: {:>02d} h {:>02d} min {:>02d} s".format(
...
print("---------- o ----------- o ------------- o ------------")
print(
    "Start at: {:>02d}/{:>02d}/{:>4d}, {:>02d} h {:>02d} min {:>02d} s".format(
        start_time.day,
        start_time.month,
        start_time.year,
        start_time.hour,
...
print(
    "Finish at: {:>02d}/{:>02d}/{:>4d}, {:>02d} h {:>02d} min {:>02d} s".format(
        end_time.day,
        end_time.month,
        end_time.year,
        end_time.hour,
